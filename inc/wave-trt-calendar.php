...
add_action( 'admin_enqueue_scripts', function ( $hook ) {
	...
	wp_enqueue_style( 'wave-trt-calendar', get_stylesheet_directory_uri() . '/assets/css/wave-trt-calendar.css', array( 'wave-trt' ), '1.0.0' );
	wp_enqueue_script( 'wave-trt-calendar', get_stylesheet_directory_uri() . '/assets/js/wave-trt-calendar.js', array(), '1.0.0', true );
} );
...
function wave_trt_calendar_render() {
	...
	<div class="wrap wave-trt wave-calendar" id="wave-calendar">
		...
		<div class="wave-year-grid" aria-label="Twelve-month patient calendar">
