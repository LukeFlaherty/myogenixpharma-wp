...
<header class="home-nav" role="banner">
	<div class="home-nav__inner">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="home-nav__logo-link" aria-label="<?php echo esc_attr( $logo_alt ); ?> home">
			<?php if ( $logo_url ) : ?>
				<img src="<?php echo esc_url( $logo_url ); ?>" alt="<?php echo esc_attr( $logo_alt ); ?>" class="home-nav__logo" width="auto" height="36">
			<?php else : ?>
		...
		<nav class="home-nav__links" aria-label="Main navigation">
			<a href="<?php echo esc_url( home_url( '/product-category/weight-loss/' ) ); ?>">Weight Management</a>
			<a href="<?php echo esc_url( home_url( '/product-category/peptides-longevity/' ) ); ?>">Peptides</a>
			<a href="#how-it-works">How it works</a>
			<a href="#faq">FAQ</a>
		</nav>

		<div class="home-nav__cta">
			<a href="<?php echo esc_url( $account_url ); ?>" class="home-nav__signin">Sign in</a>
			<a href="<?php echo esc_url( home_url( '/product-category/weight-loss/' ) ); ?>" class="home-nav__getstarted">Get started</a>
		</div>

		<div class="home-nav__mobile-right">
			<a href="<?php echo esc_url( $cart_url ); ?>" class="home-nav__cart-link" aria-label="Cart<?php echo $cart_count ? ' (' . $cart_count . ' items)' : ''; ?>">
				<svg class="home-nav__cart-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75" aria-hidden="true">
					<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
				</svg>
				<?php if ( $cart_count > 0 ) : ?>
					<span class="home-nav__cart-count" aria-hidden="true"><?php echo $cart_count; ?></span>
				<?php endif; ?>
			</a>
	...
	<nav id="home-mobile-menu" class="home-nav__mobile-menu" aria-label="Mobile navigation">
		<a href="<?php echo esc_url( home_url( '/product-category/weight-loss/' ) ); ?>">Weight Management</a>
		<a href="<?php echo esc_url( home_url( '/product-category/peptides-longevity/' ) ); ?>">Peptides</a>
		<a href="#how-it-works">How it works</a>
		<a href="#faq">FAQ</a>
		<a href="<?php echo esc_url( $account_url ); ?>">Sign in</a>
		<a href="<?php echo esc_url( home_url( '/product-category/weight-loss/' ) ); ?>" class="home-nav__mobile-getstarted">Get started</a>
	</nav>
</header>
